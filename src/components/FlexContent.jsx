   ...
   return (
      <>
         ...
         >
          ...
          drop-shadow-lg filter lg:text-4xl md:text-3xl sm:text-2xl"
               >
                  {title}
               </h1>
            ...
            <div className="relative flex w-full max-w-xl items-center justify-center lg:max-w-none">
               <img
                  src={img}
                  alt={`img/${heading}`}
                  className={`transitions-theme w-auto object-fill ${
                     ifExists
                        ? "xsm:h-36 h-60 rotate-6 hover:-rotate-12 lg:h-56 md:h-52 sm:h-44"
                        : "xsm:h-40 h-72 rotate-[19deg] hover:rotate-12 lg:h-64 md:h-60 sm:h-48"
                  }`}
               />
            </div>
         </div>
