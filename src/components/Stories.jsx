               ...
               <Splide options={splideOptions}>
                  {news.map((val, i) => (
                     <SplideSlide key={i} className="mb-0.5">
                        <div
                           className="relative grid items-center gap-4 rounded-lg pb-2 shadow
                        ...
                        >
                           <div className="flex items-center justify-center">
                              <img
                                 src={val.img}
                                 alt={`img/story${i}`}
                                 className="h-auto w-full rounded-tl-lg rounded-tr-lg object-contain 
                           ...
                           <div className="flex w-full items-center justify-center px-4">
                              <a
                                 ...
                                 target="_blank"
                                 role={"button"}
                                 className="button-theme w-full bg-gradient-to-b
                                  from-slate-900 to-black py-1.5 text-center text-slate-100 shadow-md shadow-black"
                              >
                                 {val.btn}
                              </a>
                           </div>
